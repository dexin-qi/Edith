...
// using edith::common::Status;
using edith::common::monitor::MonitorMessageItem;
using edith::common::time::Clock;
using edith::drivers::canbus::CanClient;
using edith::drivers::canbus::CanClientFactory;
using edith::drivers::canbus::CanReceiver;
using edith::drivers::canbus::SensorCanbusConf;
template <typename T>
using Writer = edith::cyber::Writer<T>;

template <typename SensorType>
class SensorCanbus : public edith::cyber::Component<> {
 public:
  // TODO(lizh): check whether we need a new msg item, say
  // MonitorMessageItem::SENSORCANBUS
  SensorCanbus()
      : monitor_logger_buffer_(
            edith::common::monitor::MonitorMessageItem::CANBUS) {}
  ~SensorCanbus();
