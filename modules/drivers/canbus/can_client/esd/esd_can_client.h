...
/**
 * @namespace edith::drivers::canbus::can
 * @brief edith::drivers::canbus::can
 */
namespace edith {
namespace drivers {
namespace canbus {
...
class EsdCanClient : public CanClient {
 public:
   ...
   *         edith::common::ErrorCode.
   */
  edith::common::ErrorCode Send(const std::vector<CanFrame> &frames,
   ...
   *         edith::common::ErrorCode.
   */
  edith::common::ErrorCode Receive(std::vector<CanFrame> *const frames,
                                    int32_t *const frame_num) override;
