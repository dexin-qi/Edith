...
DEFINE_string(localization_config_file,
              "/edith/modules/localization/conf/localization_config.pb.txt",
...
DEFINE_string(lidar_extrinsics_file,
              "/edith/modules/localization/msf/params/velodyne_params/"
...
DEFINE_string(
    ...
    "/edith/modules/localization/msf/params/gnss_params/ant_imu_leverarm.yaml",
    "Ant to imu leferarm.");
...
DEFINE_string(lidar_topic, "/edith/sensor/lidar128/compensator/PointCloud2",
...
DEFINE_string(vehicle_imu_file,
              "/edith/modules/localization/msf/params"
