...
DEFINE_string(map_dir, "/edith/modules/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/edith/modules/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");

DEFINE_string(
    vehicle_model_config_filename,
    "/edith/modules/common/vehicle_model/conf/vehicle_model_config.pb.txt",
