...
math::Vec2d VehicleStateProvider::ComputeCOMPosition(
  ...
  if ((FLAGS_state_transform_to_com_reverse &&
      ...
      (FLAGS_state_transform_to_com_drive &&
       vehicle_state_.gear() == vehicle::Chassis::GEAR_DRIVE)) {
