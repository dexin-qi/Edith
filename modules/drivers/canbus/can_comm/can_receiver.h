...
template <typename SensorType>
::edith::common::ErrorCode CanReceiver<SensorType>::Init(
  ...
  if (can_client_ == nullptr) {
    ...
    return ::edith::common::ErrorCode::CANBUS_ERROR;
  }
  ...
  is_init_ = true;
  return ::edith::common::ErrorCode::OK;
}
...
template <typename SensorType>
::edith::common::ErrorCode CanReceiver<SensorType>::Start() {
  if (is_init_ == false) {
    return ::edith::common::ErrorCode::CANBUS_ERROR;
  }
